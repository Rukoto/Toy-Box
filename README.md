...
---
## 「Open-Shell Ver.4.4.177」日本語言語ファイル
...
ダウンロード (Pre-release: 4.4.177用): [Open-Shell-4.4.172-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Open-Shell-Japanese-Language-File/4.4.172/Open-Shell-4.4.172-jp.exe)
