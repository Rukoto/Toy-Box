...
---
## 「Open-Shell Ver.4.4.172」日本語言語ファイル
...
ダウンロード (4.4.172 用): [Open-Shell-4.4.172-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Open-Shell-Japanese-Language-File/4.4.172/Open-Shell-4.4.172-jp.exe)
