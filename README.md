...
---
## 「7-Zip Ver.19.02 alpha / Ver.19.00」日本語環境対応パッチ
高い圧縮率を誇る多機能アーカイバ「[7-Zip](https://sevenzip.osdn.jp/)」の日本語環境対応パッチを更新しています。  
ヘルプ含む各ファイルの日本語化と訳文の修正、ファイルマネージャーの整形を行います。

ダウンロード: [7-Zip-19.02_x64-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-19.02_x64-jp.exe)  
ダウンロード: [7-Zip-19.02_x86-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-19.02_x86-jp.exe)  
↑Ver.19.02 alpha 用
...
ヘルプのソース (Ver.19.02): [7-Zip-19.02_Help-jp.7z](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-19.02_Help-jp.7z)  
...
ダウンロード: [Ver.4.5.30.180 用 ResourceHacker.JP(推奨)](https://github.com/Rukoto/Toy-Box/raw/master/Resource_Hacker-Japanese-File/4.5.30.180/ResourceHacker.JP)  
ダウンロード: [Ver.5.1.7.343 用 ResourceHacker.JP(非推奨)](https://github.com/Rukoto/Toy-Box/raw/master/Resource_Hacker-Japanese-File/5.1.7.343/ResourceHacker.JP)
...
---
## 「simplewall Ver.3.0.7 / Ver.2.4.6」日本語言語ファイル
...
本品は依頼品ですが、例外的に公式への PR を行うことで更新を継続する予定ではありますが、  
IDS_HIGHLIGHT_INVALID / IDS_USESTEALTHMODE_HINT に修正が必要な事は当分放置します。
