...
---
## 「Open-Shell Ver.4.4.179」日本語言語ファイル
...
ダウンロード (Pre-release: 4.4.178～4.4.179用): [Open-Shell-4.4.178-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Open-Shell-Japanese-Language-File/4.4.178/Open-Shell-4.4.178-jp.exe)
