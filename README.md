...
※Windows 10 Pro 22H2 x64 用に最適化しています。その他の OS では表示が崩れる可能性があります。  
...
ダウンロード (20221124221004): [CPU-Z-2.03.1_x64-jp-20221124221004.exe](https://github.com/Rukoto/Toy-Box/raw/master/CPU-Z-Japanese-Patch/CPU-Z-2.03.1_x64-jp-20221124221004.exe)
...
---
## 「Driver Store Explorer Ver.0.11.88」日本語言語ファイル (コメントのみ)
...
---
## 「FileZilla Client Ver.3.62.0」日本語言語ファイル (作業用)
## 「libfilezilla Ver.0.39.2」日本語言語ファイル (作業用)
...
---
## 「Homedale Ver.2.04」日本語化パッチ
WiFi/WLAN モニターアプリ「[Homedale](https://www.the-sz.com/products/homedale/)」を日本語化するパッチです。

ダウンロード: [Homedale-2.04-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Homedale-Japanese-Patch/Homedale-2.04-jp.exe)
...
---
## 「Open-Shell Ver.4.4.180」日本語言語ファイル
...
ダウンロード (Pre-release: 4.4.178～4.4.180用): [Open-Shell-4.4.178-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Open-Shell-Japanese-Language-File/4.4.178/Open-Shell-4.4.178-jp.exe)
...
---
## 「simplewall Ver.3.6.7」日本語対応言語ファイル (作業用)
