...
---
## 「Open-Shell Ver.4.4.189」日本語言語ファイル
...
ダウンロード (Pre-release: 4.4.185～4.4.189用): [Open-Shell-4.4.185-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Open-Shell-Japanese-Language-File/4.4.185/Open-Shell-4.4.185-jp.exe)
