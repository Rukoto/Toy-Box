...
---
## 「7-Zip Ver.24.08」日本語環境対応パッチ
高い圧縮率を誇る多機能アーカイバ「[7-Zip](https://www.7-zip.org/)」の日本語環境対応パッチを更新しています。  
ヘルプ含む各ファイルの日本語化と訳文の修正、ファイルマネージャーの整形を行います。

ダウンロード (x64): [7-Zip-24.08_x64-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-24.08_x64-jp.exe)  
ダウンロード (x86): [7-Zip-24.08_x86-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-24.08_x86-jp.exe)  
