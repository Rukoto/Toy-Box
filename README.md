...
---
## 「Homedale Ver.2.14」日本語化パッチ
WiFi/WLAN モニターアプリ「[Homedale](https://www.the-sz.com/products/homedale/)」を日本語化するパッチです。

ダウンロード: [Homedale-2.14-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Homedale-Japanese-Patch/Homedale-2.14-jp.exe)
...
ダウンロード (Latest: 4.4.194用): [Open-Shell-4.4.194-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Open-Shell-Japanese-Language-File/4.4.194/Open-Shell-4.4.194-jp.exe)  
ダウンロード (Pre-release: 4.4.195用): (同上)
...
---
## 「simplewall Ver.3.8.5」日本語対応言語ファイル (作業用)
