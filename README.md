...
---
## 「FileZilla Server Ver.1.5.0」日本語化パッチ
...
ダウンロード (1.5.0 用): [FileZilla_Server-1.5.0-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/FileZilla_Server-Japanese-Patch/FileZilla_Server-1.5.0-jp.exe)  
