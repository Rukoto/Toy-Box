...
---
## 「7-Zip Ver.21.01 alpha / Ver.19.00」日本語環境対応パッチ
高い圧縮率を誇る多機能アーカイバ「[7-Zip](https://sevenzip.osdn.jp/)」の日本語環境対応パッチを更新しています。  
ヘルプ含む各ファイルの日本語化と訳文の修正、ファイルマネージャーの整形を行います。

ダウンロード: [7-Zip-21.01_x64-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-21.01_x64-jp.exe)  
ダウンロード: [7-Zip-21.01_x86-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-21.01_x86-jp.exe)  
↑Ver.21.01 alpha 用
...
ヘルプのソース (Ver.21.01): [7-Zip-21.01_Help-jp.7z](https://github.com/Rukoto/Toy-Box/raw/master/7-Zip-Japanese-Patch/7-Zip-21.01_Help-jp.7z)  
...
---
## 「Driver Store Explorer Ver.0.11.70」日本語言語ファイル (コメントのみ)
...
---
## 「FileZilla Client Ver.3.53.0 / Ver.3.15.0.2」日本語言語ファイル (作業用)
...
ダウンロード: [Ver.3.53.0 用 filezilla.mo](https://github.com/Rukoto/Toy-Box/raw/master/FileZilla_Client-Japanese-Language-File/3.53.0/filezilla.mo)  
ダウンロード: [Ver.3.53.0 用 libfilezilla.mo](https://github.com/Rukoto/Toy-Box/raw/master/libfilezilla-Japanese-Language-File/libfilezilla.mo)
...
---
## 「Greenshot Ver.1.3.154」日本語言語ファイル
...
ダウンロード: [Greenshot-1.3.154jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Greenshot-Japanese-Patch/Greenshot-1.3.154jp.exe)
...
---
## 「Open-Shell Ver.4.4.163」日本語言語ファイル
...
ダウンロード: [4.4.163 用 Open-Shell-4.4.163jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Open-Shell-Japanese-Language-File/4.4.163/Open-Shell-4.4.163jp.exe)
