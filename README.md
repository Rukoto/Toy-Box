...
---
## 「FileZilla Server Ver.1.4.1」日本語化パッチ
...
ダウンロード (1.4.1 用): [FileZilla_Server-1.4.1-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/FileZilla_Server-Japanese-Patch/FileZilla_Server-1.4.1-jp.exe)  
...
---
## 「Greenshot Ver.1.3.262」日本語言語ファイル
スクリーンキャプチャアプリ「[Greenshot](https://getgreenshot.org/)」の日本語言語ファイルを更新するパッチです。  
プラグインによる Imgur へのアップロードが便利で、随分昔から愛用しています。  
Ver.1.3.262 では、キャプチャサイズが縦横共に 1px 大きくなるバグが発生しています。  
Ver.1.3.249 の利用を推奨。Ver.1.3.229 での UI 改悪は issue でてるしそのうち直りそう。

ダウンロード (1.3.244 ～ 1.3.262 用): [Greenshot-1.3.244-jp.exe](https://github.com/Rukoto/Toy-Box/raw/master/Greenshot-Japanese-Patch/Greenshot-1.3.244-jp.exe)  
